...
for r in 1:nrep
	...
	probabilities[2,:] = exp.(basal_rates[s, 1, 2, : ] .+  gammas[randomSample,Symbol("gamma_c[1,1,2]")] .* metacommunity[2,1,:,1] .+ gammas[randomSample,Symbol("gamma_c[1,1,3]")] .* metacommunity[3,1,:,1]) * (sum(metacommunity[s,1,:,1])/nsites) .+ externalS
	...
	# local_densities = (metacommunity[s, 1, :, 1]' * distmatrix[s,:,:]) ./ scaling_cst[s]
	probabilities[2,:] = exp.(basal_rates[s, 1, 2, : ] .+  gammas[randomSample,Symbol("gamma_c[1,2,1]")] .* metacommunity[1,1,:,1] .+ gammas[randomSample,Symbol("gamma_c[1,2,3]")] .* metacommunity[3,1,:,1]) * (sum(metacommunity[s,1,:,1])/nsites) .+ externalS
	...
	# local_densities = (metacommunity[s, 1, :, 1]' * distmatrix[s,:,:]) ./ scaling_cst[s]
	probabilities[2,:] = exp.(basal_rates[s, 1, 2, : ] .+  gammas[randomSample,Symbol("gamma_c[1,3,1]")] .* metacommunity[1,1,:,1] .+ gammas[randomSample,Symbol("gamma_c[1,3,2]")] .* metacommunity[2,1,:,1]) * (sum(metacommunity[s,1,:,1])/nsites) .+ externalS
	metacommunity[s, 2, :, 1] = map(x -> rand(Binomial(1,x)), metacommunity[s, 1, :, 1] .* ( 1 .- (1 .- exp.(-(probabilities[1,:].+probabilities[2,:]))).*(probabilities[1,:]./(probabilities[1,:] .+ probabilities[2,:]))) +
															 (1 .- metacommunity[s, 1, :, 1]) .* ( (1 .-  exp.(-(probabilities[1,:].+probabilities[2,:]))) .* (probabilities[2,:]./(probabilities[1,:] .+ probabilities[2,:]))))
	...
	for y in 2:nyears
		...
		probabilities[2,:] = exp.(basal_rates[s, 2, 2, : ] .+  gammas[randomSample,Symbol("gamma_c[2,1,2]")] .* metacommunity[2,2,:,y-1] .+ gammas[randomSample,Symbol("gamma_c[2,1,3]")] .* metacommunity[3,2,:,y-1]) * (sum(metacommunity[s,2,:,y-1])/nsites) .+ externalS
		...
		# local_densities = (metacommunity[s, 2, :, y-1]' * distmatrix[s,:,:]) ./ scaling_cst[s]
		probabilities[2,:] = exp.(basal_rates[s, 2, 2, : ] .+  gammas[randomSample,Symbol("gamma_c[2,2,1]")] .* metacommunity[1,2,:,y-1] .+ gammas[randomSample,Symbol("gamma_c[2,2,3]")] .* metacommunity[3,2,:,y-1]) * (sum(metacommunity[s,2,:,y-1])/nsites) .+ externalS
		...
		# local_densities = (metacommunity[s, 2, :, y-1]' * distmatrix[s,:,:]) ./ scaling_cst[s]
		probabilities[2,:] = exp.(basal_rates[s, 2, 2, : ] .+  gammas[randomSample,Symbol("gamma_c[2,3,1]")] .* metacommunity[1,2,:,y-1] .+ gammas[randomSample,Symbol("gamma_c[2,3,2]")] .* metacommunity[2,2,:,y-1]) * (sum(metacommunity[s,2,:,y-1])/nsites) .+ externalS
		...
		probabilities[2,:] = exp.(basal_rates[s, 1, 2, : ] .+  gammas[randomSample,Symbol("gamma_c[1,1,2]")] .* metacommunity[2,1,:,y] .+ gammas[randomSample,Symbol("gamma_c[1,1,3]")] .* metacommunity[3,1,:,y]) * (sum(metacommunity[s,1,:,y])/nsites) .+ externalS
		...
		# local_densities = (metacommunity[s, 1, :, y]' * distmatrix[s,:,:]) ./ scaling_cst[s]
		probabilities[2,:] = exp.(basal_rates[s, 1, 2, : ] .+  gammas[randomSample,Symbol("gamma_c[1,2,1]")] .* metacommunity[1,1,:,y] .+ gammas[randomSample,Symbol("gamma_c[1,2,3]")] .* metacommunity[3,1,:,y]) * (sum(metacommunity[s,1,:,y])/nsites) .+ externalS
		...
		# local_densities = (metacommunity[s, 1, :, y]' * distmatrix[s,:,:]) ./ scaling_cst[s]
		probabilities[2,:] = exp.(basal_rates[s, 1, 2, : ] .+  gammas[randomSample,Symbol("gamma_c[1,3,1]")] .* metacommunity[1,1,:,y] .+ gammas[randomSample,Symbol("gamma_c[1,3,2]")] .* metacommunity[2,1,:,y]) * (sum(metacommunity[s,1,:,y])/nsites) .+ externalS
